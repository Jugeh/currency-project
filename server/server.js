...
app.use("/",express.static(path.join(process.cwd(), "/project/client/currency_project/dist/index.html")));
...
app.get('*', (req, res) => {
  const filePath = path.join(process.cwd(), "/project/client/currency_project/dist/index.html");
